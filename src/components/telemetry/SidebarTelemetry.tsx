  ...
  return (
    <div className="space-y-3">
      ...
      <div className="bg-space-bg/60 border border-space-border/30 rounded px-2.5 py-1.5">
        <div className="text-[9px] font-heading uppercase tracking-[0.15em] text-text-muted mb-0.5">Phase</div>
        ...
        {phase.next && (
          <div className="text-[9px] font-mono text-text-muted mt-0.5 flex items-center gap-1">
            ...
            <span className="text-amber ml-auto shrink-0 text-[9px]">
      ...
      {progress !== null && (
        <div>
          <div className="flex items-center justify-between mb-1">
            <span className="text-[9px] font-heading uppercase tracking-[0.12em] text-text-muted">Progress</span>
